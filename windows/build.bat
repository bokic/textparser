...
cmake.exe -S .. -B build -G "Ninja" "-DCMAKE_C_COMPILER=C:/Program Files/LLVM/bin/clang.exe" "-DCMAKE_CXX_COMPILER=C:/Program Files/LLVM/bin/clang++.exe" -DBUILD_TESTS=ON || exit /b 1
