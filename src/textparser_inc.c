...
static textparser_token_item *textparser_parse_token_iterative(struct textparser_handle *handle, int start_token_id, int parent_token_id, int parent_start_stop, size_t start_offset, const textparser_token_item *parent_item, const textparser_token_item *prev_sibling)
{
    ParserStack stack;
    ...
    push_frame(&stack, start_token_id, parent_token_id, parent_start_stop, start_offset, parent_item, prev_sibling);
        ...
        switch (token_def->type) {
            ...
            case TEXTPARSER_TOKEN_TYPE_GROUP: {
                ...
                if (f->state_step == 1) {
                    ...
                    textparser_token_item *current_prev = (f->u.group.child == nullptr) ? f->prev_sibling : f->u.group.child;
            ...
            case TEXTPARSER_TOKEN_TYPE_START_OPT_STOP: {
                ...
                if (f->state_step == 0) {
                    ...
                    {
                        int adjusted_list[nested_count + 1];
                        adjust_search_order(handle, ret, current_prev, f->u.start_stop.nested_tokens, adjusted_list);
...
{
    return textparser_parse_token_iterative(handle, token_id, parent_token_id, parent_start_stop, offset, parent_item, prev_sibling);
}
...
static void textparser_inc_free_language_definition(textparser_language_definition *definition)
{
...
static int textparser_inc_openfile(const char *pathname, int default_text_format, textparser_t *handle)
{
...
static int textparser_inc_openmem(const char *text, int len, int text_format, textparser_t *handle)
{
...
static void textparser_inc_close(textparser_t handle)
{
...
static void textparser_inc_cleanup(textparser_t *handle)
{
    if (handle)
    {
...
static int textparser_inc_parse_full(textparser_t handle, const textparser_language_definition *definition)
{
    if (handle == nullptr || definition == nullptr) return -1;
    ...
    return textparser_parse_incremental(handle, definition, nullptr, 0, total_units);
}

static const char *textparser_inc_parse_error(textparser_t handle)
{
    return handle->error;
}

static size_t textparser_inc_parse_error_position(textparser_t handle)
{
    return handle->error_offset;
}

static void textparser_inc_set_callback(textparser_t handle, void (*callback)(textparser_t, textparser_token_item *, enum textparser_callback_type callback_type, void *user_data), void *user_data)
{
    if (handle) {
...
static const char *textparser_inc_get_text(textparser_t handle)
{
    if (handle == nullptr)
        return nullptr;
...
static size_t textparser_inc_get_text_size(textparser_t handle)
{
    if (handle == nullptr)
        return 0;
...
static textparser_token_item *textparser_inc_get_first_token(const textparser_t handle)
{
    if (handle == nullptr)
        return nullptr;
...
static char *textparser_inc_get_token_text(const textparser_t handle, const textparser_token_item *item)
{
    char *ret = nullptr;
...
static uint16_t *textparser_inc_get_token_text16(const textparser_t handle, const textparser_token_item *item)
{
    if ((handle == nullptr)||(item == nullptr)||(item->len <= 0))
        return nullptr;
...
static uint32_t *textparser_inc_get_token_text32(const textparser_t handle, const textparser_token_item *item)
{
    if ((handle == nullptr)||(item == nullptr)||(item->len <= 0))
        return nullptr;
...
static const textparser_language_definition *textparser_inc_get_language(const textparser_t handle)
{
    if (handle == nullptr)
        return nullptr;
...
static size_t textparser_inc_get_token_children_count(const textparser_token_item *token)
{
    size_t ret = 0;
...
static const textparser_token_item *textparser_inc_get_token_child(const textparser_token_item *token)
{
    if (token == nullptr)
        return nullptr;
...
static const textparser_token_item *textparser_inc_get_token_next(const textparser_token_item *token)
{
    if (token == nullptr)
        return nullptr;
...
static const textparser_token_item *textparser_inc_get_token_prev(const textparser_token_item *token)
{
    if (token == nullptr)
        return nullptr;
...
static const char *textparser_inc_get_token_type_str(const textparser_language_definition *language, const textparser_token_item *token)
{
    int token_id = 0;
...
static int textparser_inc_get_token_type(const textparser_token_item *token)
{
    if (token == nullptr)
        return -1;
...
static size_t textparser_inc_get_token_position(const textparser_token_item *token)
{
    if (token == nullptr)
        return 0;
...
static size_t textparser_inc_get_token_length(const textparser_token_item *token)
{
    if (token == nullptr)
        return 0;
...
static uint32_t textparser_inc_get_token_text_color(const textparser_token_item *token)
{
    if (token == nullptr)
        return 0;
...
static uint32_t textparser_inc_get_token_text_background(const textparser_token_item *token)
{
    if (token == nullptr)
        return 0;
...
static uint32_t textparser_inc_get_token_text_flags(const textparser_token_item *token)
{
    if (token == nullptr)
        return 0;
...
static const char *textparser_inc_get_token_error(const textparser_token_item *token)
{
    if (token == nullptr)
        return nullptr;
...
static textparser_parser_state *textparser_inc_state_new(const textparser_t handle)
{
...
static void textparser_inc_state_free(textparser_parser_state *state)
{
    if (state)
    {
        free(state);
...
static void textparser_inc_state_cleanup(textparser_parser_state **state)
{
    if (state)
    {
...
static int textparser_inc_build_line_map(textparser_t handle)
{
    if (handle == nullptr)
        return -1;
...
static size_t textparser_inc_get_line_count(const textparser_t handle)
{
    if (handle == nullptr)
        return 0;
...
static size_t textparser_inc_get_line_start_position(const textparser_t handle, size_t line_index)
{
    if (handle == nullptr)
        return 0;
...
static size_t textparser_inc_get_line_number_at_position(const textparser_t handle, size_t position)
{
