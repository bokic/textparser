...
/* _gen_bash_Keyword_start_ */
...
/* _gen_bash_ArithmeticExpression_start_XCRcKFwofFwoXCg= */
EXPORT_TEXTPARSER bool _gen_bash_ArithmeticExpression_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_ArithmeticExpression_end_XClcKQ== */
EXPORT_TEXTPARSER bool _gen_bash_ArithmeticExpression_end(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_CommandSubstitution_start_XCRcKCg/IVwoKQ== */
...
/* _gen_bash_CommandSubstitution_end_XCk= */
...
/* _gen_bash_ProcessSubstitution_start_PFwofD5cKA== */
EXPORT_TEXTPARSER bool _gen_bash_ProcessSubstitution_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_ProcessSubstitution_end_XCk= */
EXPORT_TEXTPARSER bool _gen_bash_ProcessSubstitution_end(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_BacktickSubstitution_start_YA== */
EXPORT_TEXTPARSER bool _gen_bash_BacktickSubstitution_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_BacktickSubstitution_end_YA== */
EXPORT_TEXTPARSER bool _gen_bash_BacktickSubstitution_end(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_TestExpression_start_XFtcWw== */
EXPORT_TEXTPARSER bool _gen_bash_TestExpression_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_bash_TestExpression_end_XF1cXQ== */
EXPORT_TEXTPARSER bool _gen_bash_TestExpression_end(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_bash_Path_start_W2EtekEtWjAtOV8ufi1dKlwvW2EtekEtWjAtOV8ufi8tXSs= */
EXPORT_TEXTPARSER bool _gen_bash_Path_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_bash_Operator_start_JiZ8XHxcfHw+Pnw8PHw9PXwhPXxcKz18XC09fFwqPXwvPXwlPXwmPXxcfD18XF49fDw8PXw+Pj18XCtcK3xcLVwtfDs7fDsmfDs7JnxcfCZ8PDw8fDw8LXw+Jnw8JnwmPj58Jj58Plx8fDw+fDw9fD49fD1+fDotfDo9fDpcK3w6XD98Ly98IyN8JSV8XF5cXnwsLHxbLSsqLyUmfF5+PD4hPTsuLHw6XQ== */
...
/* _gen_bash_ArithmeticOperator_start_XCpcKnw8PD18Pj49fFwrPXxcLT18XCo9fC89fCU9fCY9fFx8PXxcXj18XCtcK3xcLVwtfDw8fD4+fDw9fD49fD09fCE9fCYmfFx8XHx8Wy0rKi8lJnxefjw+IT0/Oj1d */
EXPORT_TEXTPARSER bool _gen_bash_ArithmeticOperator_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_bash_StringEscape_start_XFxcXHxcXFwifFxcXCd8XFxufFxccnxcXHR8XFxcJHxcXFxgfFxcYXxcXGJ8XFxbZUVdfFxcZnxcXHZ8XFxcP3xcXHhbMC05YS1mQS1GXXsxLDJ9fFxcdVswLTlhLWZBLUZdezEsNH18XFxVWzAtOWEtZkEtRl17MSw4fXxcXGNbYS16QS1aXXxcXFswLTddezEsM30= */
...
/* _gen_bash_Number_start_MFt4WF1bMC05YS1mQS1GXSt8MFtvT11bMC03XSt8MFtiQl1bMDFdK3xbMC05XSsjWzAtOWEtekEtWkBfXSt8WzAtOV0qXC4/WzAtOV0rKD86W2VFXVstK10/WzAtOV0rKT8= */
...
/* _gen_c_Attribute_start_XFtcWw== */
EXPORT_TEXTPARSER bool _gen_c_Attribute_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_c_Attribute_end_XF1cXQ== */
EXPORT_TEXTPARSER bool _gen_c_Attribute_end(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_c_SingleString_start_KD86dTh8dXxVfEwpPyc= */
...
/* _gen_c_DoubleString_start_KD86dTh8dXxVfEwpPyI= */
...
/* _gen_c_FormatSpecifier_start_JSg/OiV8KD86WzEtOV1bMC05XSpcJCk/Wy0rICMwJ10qKD86XCooPzpbMS05XVswLTldKlwkKT98WzAtOV0rKT8oPzpcLig/OlwqKD86WzEtOV1bMC05XSpcJCk/fFswLTldKikpPyg/OmhofGxsfFtobGp6dExdKT9bZGlvdXhYZkZlRWdHYUFjc3BuYkJdKQ== */
EXPORT_TEXTPARSER bool _gen_c_FormatSpecifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_c_StringEscape_start_XFxcXHxcXFwifFxcXCd8XFxufFxccnxcXHR8XFx2fFxcZnxcXGF8XFxifFxcZXxcXDB8XFx1WzAtOWEtZkEtRl17NH18XFxVWzAtOWEtZkEtRl17OH18XFx4WzAtOWEtZkEtRl0rfFxbMC03XXsxLDN9 */
...
/* _gen_c_Number_start_ */
...
/* _gen_c_DataType_start_ */
EXPORT_TEXTPARSER bool _gen_c_DataType_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_c_TypeName_start_W2EtekEtWl9dW2EtekEtWjAtOV9dKg== */
EXPORT_TEXTPARSER bool _gen_c_TypeName_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_c_TagSpecifier_start_c3RydWN0XGJ8dW5pb25cYnxlbnVtXGI= */
EXPORT_TEXTPARSER bool _gen_c_TagSpecifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_cfml_EndTag_start_PFwvKD86Y2YoPyEoPzpvdXRwdXR8c2NyaXB0fHF1ZXJ5fGxvb3B8bWFpbHxzYXZlY29udGVudClcYilbYS16MC05X10qfFthLXowLTlfXSs6W2EtejAtOV9dKyk= */
...
/* _gen_cfml_ScriptLineComment_start_XC9cL1teXHJcbl0q */
...
/* _gen_cfml_MulOperator_start_XCp8XC8= */
...
/* _gen_cfml_IntegerDivOperator_start_XFw= */
EXPORT_TEXTPARSER bool _gen_cfml_IntegerDivOperator_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_cfml_ModOperator_start_bW9kXGJ8XCU= */
EXPORT_TEXTPARSER bool _gen_cfml_ModOperator_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
...
/* _gen_typescript_TypeofKeyword_start_dHlwZW9mXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_TypeofKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_VoidKeyword_start_dm9pZFxi */
EXPORT_TEXTPARSER bool _gen_typescript_VoidKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DeleteKeyword_start_ZGVsZXRlXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_DeleteKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AwaitKeyword_start_YXdhaXRcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_AwaitKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_YieldKeyword_start_eWllbGRcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_YieldKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InstanceofKeyword_start_aW5zdGFuY2VvZlxi */
EXPORT_TEXTPARSER bool _gen_typescript_InstanceofKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InKeyword_start_aW5cYg== */
EXPORT_TEXTPARSER bool _gen_typescript_InKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_OutKeyword_start_b3V0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_OutKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ThisKeyword_start_dGhpc1xi */
EXPORT_TEXTPARSER bool _gen_typescript_ThisKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TrueKeyword_start_dHJ1ZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_TrueKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_FalseKeyword_start_ZmFsc2VcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_FalseKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NullKeyword_start_bnVsbFxi */
EXPORT_TEXTPARSER bool _gen_typescript_NullKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UndefinedKeyword_start_dW5kZWZpbmVkXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_UndefinedKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AnyKeyword_start_YW55XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_AnyKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UnknownKeyword_start_dW5rbm93blxi */
EXPORT_TEXTPARSER bool _gen_typescript_UnknownKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NeverKeyword_start_bmV2ZXJcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_NeverKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NumberKeyword_start_bnVtYmVyXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_NumberKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BigIntKeyword_start_YmlnaW50XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_BigIntKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BooleanKeyword_start_Ym9vbGVhblxi */
EXPORT_TEXTPARSER bool _gen_typescript_BooleanKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_StringKeyword_start_c3RyaW5nXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_StringKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_SymbolKeyword_start_c3ltYm9sXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_SymbolKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ObjectKeyword_start_b2JqZWN0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ObjectKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_KeyofKeyword_start_a2V5b2ZcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_KeyofKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ReadonlyKeyword_start_cmVhZG9ubHlcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ReadonlyKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UniqueKeyword_start_dW5pcXVlXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_UniqueKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InferKeyword_start_aW5mZXJcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_InferKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ExtendsKeyword_start_ZXh0ZW5kc1xi */
EXPORT_TEXTPARSER bool _gen_typescript_ExtendsKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NewKeyword_start_bmV3XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_NewKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AbstractKeyword_start_YWJzdHJhY3RcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_AbstractKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_IsKeyword_start_aXNcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_IsKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AssertsKeyword_start_YXNzZXJ0c1xi */
EXPORT_TEXTPARSER bool _gen_typescript_AssertsKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AsKeyword_start_YXNcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_AsKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_SatisfiesKeyword_start_c2F0aXNmaWVzXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_SatisfiesKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ImportKeyword_start_aW1wb3J0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ImportKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_IfKeyword_start_aWZcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_IfKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ElseKeyword_start_ZWxzZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_ElseKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_WhileKeyword_start_d2hpbGVcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_WhileKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DoKeyword_start_ZG9cYg== */
EXPORT_TEXTPARSER bool _gen_typescript_DoKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ForKeyword_start_Zm9yXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ForKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_OfKeyword_start_b2ZcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_OfKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ContinueKeyword_start_Y29udGludWVcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ContinueKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BreakKeyword_start_YnJlYWtcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_BreakKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ReturnKeyword_start_cmV0dXJuXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ReturnKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ThrowKeyword_start_dGhyb3dcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ThrowKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_SwitchKeyword_start_c3dpdGNoXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_SwitchKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_CaseKeyword_start_Y2FzZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_CaseKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DefaultKeyword_start_ZGVmYXVsdFxi */
EXPORT_TEXTPARSER bool _gen_typescript_DefaultKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TryKeyword_start_dHJ5XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_TryKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_CatchKeyword_start_Y2F0Y2hcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_CatchKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_FinallyKeyword_start_ZmluYWxseVxi */
EXPORT_TEXTPARSER bool _gen_typescript_FinallyKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_WithKeyword_start_d2l0aFxi */
EXPORT_TEXTPARSER bool _gen_typescript_WithKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DebuggerKeyword_start_ZGVidWdnZXJcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_DebuggerKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_VarKeyword_start_dmFyXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_VarKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LetKeyword_start_bGV0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_LetKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ConstKeyword_start_Y29uc3RcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ConstKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_FunctionKeyword_start_ZnVuY3Rpb25cYg== */
EXPORT_TEXTPARSER bool _gen_typescript_FunctionKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ClassKeyword_start_Y2xhc3NcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ClassKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InterfaceKeyword_start_aW50ZXJmYWNlXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_InterfaceKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TypeKeyword_start_dHlwZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_TypeKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_EnumKeyword_start_ZW51bVxi */
EXPORT_TEXTPARSER bool _gen_typescript_EnumKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NamespaceKeyword_start_bmFtZXNwYWNlXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_NamespaceKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ModuleKeyword_start_bW9kdWxlXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ModuleKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DeclareKeyword_start_ZGVjbGFyZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_DeclareKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AsyncKeyword_start_YXN5bmNcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_AsyncKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_PublicKeyword_start_cHVibGljXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_PublicKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_PrivateKeyword_start_cHJpdmF0ZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_PrivateKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ProtectedKeyword_start_cHJvdGVjdGVkXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ProtectedKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_StaticKeyword_start_c3RhdGljXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_StaticKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_OverrideKeyword_start_b3ZlcnJpZGVcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_OverrideKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AccessorKeyword_start_YWNjZXNzb3JcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_AccessorKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_GetKeyword_start_Z2V0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_GetKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_SetKeyword_start_c2V0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_SetKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ConstructorKeyword_start_Y29uc3RydWN0b3JcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_ConstructorKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ImplementsKeyword_start_aW1wbGVtZW50c1xi */
EXPORT_TEXTPARSER bool _gen_typescript_ImplementsKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ExportKeyword_start_ZXhwb3J0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_ExportKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_FromKeyword_start_ZnJvbVxi */
EXPORT_TEXTPARSER bool _gen_typescript_FromKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RequireKeyword_start_cmVxdWlyZVxi */
EXPORT_TEXTPARSER bool _gen_typescript_RequireKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_GlobalKeyword_start_Z2xvYmFsXGI= */
EXPORT_TEXTPARSER bool _gen_typescript_GlobalKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_AssertKeyword_start_YXNzZXJ0XGI= */
EXPORT_TEXTPARSER bool _gen_typescript_AssertKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DeferKeyword_start_ZGVmZXJcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_DeferKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UsingKeyword_start_dXNpbmdcYg== */
EXPORT_TEXTPARSER bool _gen_typescript_UsingKeyword_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Hashbang_start_IyFbXlxyXG5dKg== */
EXPORT_TEXTPARSER bool _gen_typescript_Hashbang_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InvalidHashbang_start_IyFbXlxyXG5dKg== */
EXPORT_TEXTPARSER bool _gen_typescript_InvalidHashbang_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BigIntLiteral_start_KD86MFt4WF1bMC05YS1mQS1GXSg/Ol8/WzAtOWEtZkEtRl0pKnwwW29PXVswLTddKD86Xz9bMC03XSkqfDBbYkJdWzAxXSg/Ol8/WzAxXSkqfFswLTldKD86Xz9bMC05XSkqKW5cYg== */
EXPORT_TEXTPARSER bool _gen_typescript_BigIntLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NumericLiteral_start_ */
EXPORT_TEXTPARSER bool _gen_typescript_NumericLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_StringLiteral_start_Jyg/OlteJ1xcXHJcbl18XFwoPzpcclxufFtcc1xTXSkpKid8Iig/OlteIlxcXHJcbl18XFwoPzpcclxufFtcc1xTXSkpKiI= */
EXPORT_TEXTPARSER bool _gen_typescript_StringLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NoSubstitutionTemplateLiteral_start_YCg/OlteYFxcJF18XFwoPzpcclxufFtcc1xTXSl8XCQoPyFceykpKmA= */
EXPORT_TEXTPARSER bool _gen_typescript_NoSubstitutionTemplateLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TemplateHead_start_YCg/OlteYFxcJF18XFwoPzpcclxufFtcc1xTXSl8XCQoPyFceykpKlwkXHs= */
EXPORT_TEXTPARSER bool _gen_typescript_TemplateHead_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TemplateMiddle_start_XH0oPzpbXmBcXCRdfFxcKD86XHJcbnxbXHNcU10pfFwkKD8hXHspKSpcJFx7 */
EXPORT_TEXTPARSER bool _gen_typescript_TemplateMiddle_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TemplateTail_start_XH0oPzpbXmBcXCRdfFxcKD86XHJcbnxbXHNcU10pfFwkKD8hXHspKSpg */
EXPORT_TEXTPARSER bool _gen_typescript_TemplateTail_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InvalidNumericLiteral_start_KD86MFt4WF1bMC05QS1aYS16X10qfDBbb09dWzAtOUEtWmEtel9dKnwwW2JCXVswLTlBLVphLXpfXSp8WzAtOV0rKD86X18rWzAtOV9dKnxfKSkoPzpuKT9cYg== */
EXPORT_TEXTPARSER bool _gen_typescript_InvalidNumericLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UnterminatedStringLiteral_start_Jyg/OlteJ1xcXHJcbl18XFxbXlxyXG5dKSooPz1ccnxcbnwkKXwiKD86W14iXFxcclxuXXxcXFteXHJcbl0pKig/PVxyfFxufCQp */
EXPORT_TEXTPARSER bool _gen_typescript_UnterminatedStringLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UnterminatedTemplateLiteral_start_YCg/OlteYFxcJF18XFwoPzpcclxufFtcc1xTXSl8XCQoPyFceykpKig/PSQp */
EXPORT_TEXTPARSER bool _gen_typescript_UnterminatedTemplateLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RegularExpressionLiteral_start_Lyg/OlteL1xcXHJcblxbXXxcXC58XFsoPzpbXlxdXFxcclxuXXxcXC4pKlxdKSsvW2EtekEtWl0q */
EXPORT_TEXTPARSER bool _gen_typescript_RegularExpressionLiteral_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_StrictEqual_start_PT09 */
EXPORT_TEXTPARSER bool _gen_typescript_StrictEqual_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_StrictNotEqual_start_IT09 */
EXPORT_TEXTPARSER bool _gen_typescript_StrictNotEqual_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UnsignedRightShift_start_Pj4+ */
EXPORT_TEXTPARSER bool _gen_typescript_UnsignedRightShift_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Exponent_start_XCpcKg== */
EXPORT_TEXTPARSER bool _gen_typescript_Exponent_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Increment_start_XCtcKw== */
EXPORT_TEXTPARSER bool _gen_typescript_Increment_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Decrement_start_LS0= */
EXPORT_TEXTPARSER bool _gen_typescript_Decrement_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Equal_start_PT0= */
EXPORT_TEXTPARSER bool _gen_typescript_Equal_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NotEqual_start_IT0= */
EXPORT_TEXTPARSER bool _gen_typescript_NotEqual_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LessEqual_start_PD0= */
EXPORT_TEXTPARSER bool _gen_typescript_LessEqual_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_GreaterEqual_start_Pj0= */
EXPORT_TEXTPARSER bool _gen_typescript_GreaterEqual_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LeftShift_start_PDw= */
EXPORT_TEXTPARSER bool _gen_typescript_LeftShift_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RightShift_start_Pj4= */
EXPORT_TEXTPARSER bool _gen_typescript_RightShift_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LogicalAnd_start_JiY= */
EXPORT_TEXTPARSER bool _gen_typescript_LogicalAnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LogicalOr_start_XHxcfA== */
EXPORT_TEXTPARSER bool _gen_typescript_LogicalOr_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NullishCoalesce_start_XD9cPw== */
EXPORT_TEXTPARSER bool _gen_typescript_NullishCoalesce_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_OptionalChain_start_XD9cLig/IVswLTldKQ== */
EXPORT_TEXTPARSER bool _gen_typescript_OptionalChain_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_PlusAssign_start_XCs9 */
EXPORT_TEXTPARSER bool _gen_typescript_PlusAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_MinusAssign_start_LT0= */
EXPORT_TEXTPARSER bool _gen_typescript_MinusAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_MultiplyAssign_start_XCo9 */
EXPORT_TEXTPARSER bool _gen_typescript_MultiplyAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_DivideAssign_start_Lz0= */
EXPORT_TEXTPARSER bool _gen_typescript_DivideAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RemainderAssign_start_JT0= */
EXPORT_TEXTPARSER bool _gen_typescript_RemainderAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_ExponentAssign_start_XCpcKj0= */
EXPORT_TEXTPARSER bool _gen_typescript_ExponentAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LeftShiftAssign_start_PDw9 */
EXPORT_TEXTPARSER bool _gen_typescript_LeftShiftAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RightShiftAssign_start_Pj49 */
EXPORT_TEXTPARSER bool _gen_typescript_RightShiftAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_UnsignedRightShiftAssign_start_Pj4+PQ== */
EXPORT_TEXTPARSER bool _gen_typescript_UnsignedRightShiftAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitAndAssign_start_Jj0= */
EXPORT_TEXTPARSER bool _gen_typescript_BitAndAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitOrAssign_start_XHw9 */
EXPORT_TEXTPARSER bool _gen_typescript_BitOrAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitXorAssign_start_XF49 */
EXPORT_TEXTPARSER bool _gen_typescript_BitXorAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_NullishCoalesceAssign_start_XD9cPz0= */
EXPORT_TEXTPARSER bool _gen_typescript_NullishCoalesceAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LogicalAndAssign_start_JiY9 */
EXPORT_TEXTPARSER bool _gen_typescript_LogicalAndAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LogicalOrAssign_start_XHxcfD0= */
EXPORT_TEXTPARSER bool _gen_typescript_LogicalOrAssign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Arrow_start_PT4= */
EXPORT_TEXTPARSER bool _gen_typescript_Arrow_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Ellipsis_start_XC5cLlwu */
EXPORT_TEXTPARSER bool _gen_typescript_Ellipsis_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LParen_start_XCg= */
EXPORT_TEXTPARSER bool _gen_typescript_LParen_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RParen_start_XCk= */
EXPORT_TEXTPARSER bool _gen_typescript_RParen_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LBracket_start_XFs= */
EXPORT_TEXTPARSER bool _gen_typescript_LBracket_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RBracket_start_XF0= */
EXPORT_TEXTPARSER bool _gen_typescript_RBracket_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LBrace_start_XHs= */
EXPORT_TEXTPARSER bool _gen_typescript_LBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_RBrace_start_XH0= */
EXPORT_TEXTPARSER bool _gen_typescript_RBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Dot_start_XC4= */
EXPORT_TEXTPARSER bool _gen_typescript_Dot_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Semicolon_start_Ow== */
EXPORT_TEXTPARSER bool _gen_typescript_Semicolon_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Question_start_XD8= */
EXPORT_TEXTPARSER bool _gen_typescript_Question_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Colon_start_Og== */
EXPORT_TEXTPARSER bool _gen_typescript_Colon_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Comma_start_LA== */
EXPORT_TEXTPARSER bool _gen_typescript_Comma_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Assign_start_PQ== */
EXPORT_TEXTPARSER bool _gen_typescript_Assign_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Plus_start_XCs= */
EXPORT_TEXTPARSER bool _gen_typescript_Plus_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Minus_start_LQ== */
EXPORT_TEXTPARSER bool _gen_typescript_Minus_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Multiply_start_XCo= */
EXPORT_TEXTPARSER bool _gen_typescript_Multiply_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Slash_start_Lw== */
EXPORT_TEXTPARSER bool _gen_typescript_Slash_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Remainder_start_JQ== */
EXPORT_TEXTPARSER bool _gen_typescript_Remainder_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LessThan_start_PA== */
EXPORT_TEXTPARSER bool _gen_typescript_LessThan_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_GreaterThan_start_Pg== */
EXPORT_TEXTPARSER bool _gen_typescript_GreaterThan_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitAnd_start_Jg== */
EXPORT_TEXTPARSER bool _gen_typescript_BitAnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitOr_start_XHw= */
EXPORT_TEXTPARSER bool _gen_typescript_BitOr_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitXor_start_XF4= */
EXPORT_TEXTPARSER bool _gen_typescript_BitXor_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LogicalNot_start_IQ== */
EXPORT_TEXTPARSER bool _gen_typescript_LogicalNot_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BitNot_start_fg== */
EXPORT_TEXTPARSER bool _gen_typescript_BitNot_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_At_start_QA== */
EXPORT_TEXTPARSER bool _gen_typescript_At_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_Identifier_start_KD86WyRfXHB7SURfU3RhcnR9XXxcXHUoPzpbMC05YS1mQS1GXXs0fXxce1swLTlhLWZBLUZdezEsNn1cfSkpKD86WyRceHsyMDBDfVx4ezIwMER9XHB7SURfQ29udGludWV9XXxcXHUoPzpbMC05YS1mQS1GXXs0fXxce1swLTlhLWZBLUZdezEsNn1cfSkpKg== */
EXPORT_TEXTPARSER bool _gen_typescript_Identifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_PrivateIdentifier_start_Iyg/OlskX1xwe0lEX1N0YXJ0fV18XFx1KD86WzAtOWEtZkEtRl17NH18XHtbMC05YS1mQS1GXXsxLDZ9XH0pKSg/OlskXHh7MjAwQ31ceHsyMDBEfVxwe0lEX0NvbnRpbnVlfV18XFx1KD86WzAtOWEtZkEtRl17NH18XHtbMC05YS1mQS1GXXsxLDZ9XH0pKSo= */
EXPORT_TEXTPARSER bool _gen_typescript_PrivateIdentifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_InvalidIdentifier_start_KD86Iyk/XFx1KD86WzAtOWEtZkEtRl17NH18XHtbMC05YS1mQS1GXXsxLDZ9XH0pKD86WyRceHsyMDBDfVx4ezIwMER9XHB7SURfQ29udGludWV9XXxcXHUoPzpbMC05YS1mQS1GXXs0fXxce1swLTlhLWZBLUZdezEsNn1cfSkpKg== */
EXPORT_TEXTPARSER bool _gen_typescript_InvalidIdentifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXOpen_start_PA== */
EXPORT_TEXTPARSER bool _gen_typescript_JSXOpen_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXCloseStart_start_PC8= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXCloseStart_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXTagEnd_start_Pg== */
EXPORT_TEXTPARSER bool _gen_typescript_JSXTagEnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXClosingTagEnd_start_Pg== */
EXPORT_TEXTPARSER bool _gen_typescript_JSXClosingTagEnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXSelfClosingEnd_start_Lz4= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXSelfClosingEnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXExpressionStart_start_XHs= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXExpressionStart_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXExpressionEnd_start_XH0= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXExpressionEnd_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXExpressionLBrace_start_XHs= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXExpressionLBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXExpressionRBrace_start_XH0= */
EXPORT_TEXTPARSER bool _gen_typescript_JSXExpressionRBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXIdentifier_start_WyRfXHB7TH1ccHtObH1dWyRfXHB7TH1ccHtObH1ccHtNbn1ccHtNY31ccHtOZH1ccHtQY31ceHsyMDBDfVx4ezIwMER9LV0q */
EXPORT_TEXTPARSER bool _gen_typescript_JSXIdentifier_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_JSXText_start_W148e10r */
EXPORT_TEXTPARSER bool _gen_typescript_JSXText_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TemplateLBrace_start_XHs= */
EXPORT_TEXTPARSER bool _gen_typescript_TemplateLBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_TemplateNestedRBrace_start_XH0= */
EXPORT_TEXTPARSER bool _gen_typescript_TemplateNestedRBrace_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_WhitespaceTrivia_start_WyBcdFxyXG5dKw== */
EXPORT_TEXTPARSER bool _gen_typescript_WhitespaceTrivia_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_LineCommentTrivia_start_Ly9bXlxyXG5dKg== */
EXPORT_TEXTPARSER bool _gen_typescript_LineCommentTrivia_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);

/* _gen_typescript_BlockCommentTrivia_start_L1wqKD86W14qXXxcKig/IS8pKSpcKi8= */
EXPORT_TEXTPARSER bool _gen_typescript_BlockCommentTrivia_start(enum textparser_encoding encoding, const char *start, size_t max_len, size_t *offset, size_t *length, bool is_caseless, bool only_at_start);
