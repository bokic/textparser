...
static void verify_negative_number(const textparser_language_definition *definition, const char *lang_name) {
    ...
    else if (strcmp(lang_name, "C") == 0 || strcmp(lang_name, "C++") == 0 || strcmp(lang_name, "C#") == 0 || strcmp(lang_name, "Java") == 0 || strcmp(lang_name, "Python") == 0 || strcmp(lang_name, "Go") == 0 || strcmp(lang_name, "Swift") == 0 || strcmp(lang_name, "Pascal") == 0 || strcmp(lang_name, "VB") == 0 || strcmp(lang_name, "Perl") == 0)
        // v2 C/C++/C#/Java/Python/Go/Swift/Pascal/VB keep the unary minus (Minus)
