...
- **Incremental Parsing (`textparser_parse_incremental`)**: Efficiently re-parses modified buffers in interactive environments (like text editors and IDEs) by tracking changed byte ranges and reusing unaffected AST branches.
