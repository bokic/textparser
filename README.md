...
- **API Documentation**: Public headers (`textparser.h`, `textparser-json.h`) feature comprehensive Doxygen-style function explanation blocks detailing parameter contracts, return codes, and ownership rules.
